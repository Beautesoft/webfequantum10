                    ...
                    onClick={() => {
                      ...
                      this.props
                        ...
                        .then((resCreateAddr) => {
                          console.log("resCreateAddr", resCreateAddr);
                          if (
                            resCreateAddr.status == 201 ||
                            resCreateAddr.status == 200
                          ) {
                            alert(resCreateAddr.message);
                            this.props.history.push({
                              pathname: "/admin/quantum/",
                            });
                          } else {
              ...
              {disableEdit == true ? (
                <div className="col-md-2 col-12 mt-3">
                  <NormalButton
                    ...
                    onClick={() =>
                      importInvoiceToXero(this.state.storedItemListStored,this.state.formFields)
                    }
                  />
                </div>
              ) : null}
